...
func destroyLabEnvironment(labName string) {
	...
	if len(containersIds) > 0 {
		...
		currentUserUsername := currentUser.Username
        	...
        	res_output := "[" + formatedTime + "] [+] Operación: Destrucción del entorno exitosa || [+] Nombre del entorno: " + labName + " (Usuario: " + currentUserUsername + ")\n"
		...
		//Obtención de la fecha actual
                ...
                res_output := "[" + formatedTime + "] [+] Operación: Destrucción del entorno fallida (No existen contenedores asociados al entorno)|| [+] Nombre del entorno: " + labName + " (Usuario: " + currentUserUsername + ")\n"
